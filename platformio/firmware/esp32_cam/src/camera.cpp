...
bool CameraController::begin() {
    ...
    // Use SVGA or QVGA to conserve memory and transmission bandwidth
    if (psramFound()) {
    ...
    // Drop down frame size for initial testing stability
    s->set_framesize(s, FRAMESIZE_QVGA);

    Serial.println("[CAMERA] Camera successfully initialized.");
    return true;
}
